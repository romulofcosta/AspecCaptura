...
echo "Iniciando instalação do .NET 10..."
curl -sSL https://dot.net/v1/dotnet-install.sh -o dotnet-install.sh
chmod +x dotnet-install.sh
./dotnet-install.sh --channel 10.0 --install-dir "$PWD/.dotnet"
...
dotnet publish pwa-camera-poc-blazor.csproj -c Release -o bin/Release/net10.0/publish
...
if [ -d "bin/Release/net10.0/publish/wwwroot" ]; then
    echo "Movendo conteúdo de wwwroot para a raiz..."
    cp -rv bin/Release/net10.0/publish/wwwroot/* bin/Release/net10.0/publish/
    # Opcional: remover a pasta wwwroot vazia para evitar confusão
    # rm -rf bin/Release/net10.0/publish/wwwroot
fi

echo "Conteúdo final do diretório de publicação:"
ls -F bin/Release/net10.0/publish/
